local style = Class("britui_basicdisablestyle", _BRITUI.STYLE)

function style:initialize()
    _BRITUI.STYLE.initialize(self)
    self.name = "basic disable"
    self.font = SmallFont
    ...
    local buttonimg, buttonquads, buttoncornersize = self:CreateImageButton("graphics/UIstyles/basic disable.png",11)
